      ...
      return Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            FlatButton(
              child: Text(
                chairControlInfo.temperatureMonitor.lowLimitText,
              ...
              onPressed: () {
                showDialog(
                  ...
                  builder: (BuildContext context) {
                    return SliderDialog(
                      isHigh: false,
                      initValue: chairControlInfo.temperatureMonitor.lowLimit,
                    );
                  },
                );
              },
            ),
            TemperatureSwitch(isHigh: false),
          ],
        ),
      );
    });
